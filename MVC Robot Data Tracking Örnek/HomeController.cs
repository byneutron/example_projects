...
namespace Robot_Tracking.Controllers
{
    public class HomeController : Controller
    {
        ...
        public JsonResult Get()
        {
            ...
            {
                connection.Open();
                using (SqlCommand command = new SqlCommand(@"SELECT [MacSTime] FROM [dbo].[Properties]", connection))
                {
